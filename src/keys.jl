...
n=60 (0.812ns, the index's best figure); k=2 is very slightly
...
"""
    atom_key(atom::SparseMatrixCSC; k=DEFAULT_K) -> UInt64
...
"""
    atom_key(atom::SparseVector; k=DEFAULT_K) -> UInt64
...
"""
    atom_key(atom::Array{<:Real}; k=DEFAULT_K) -> Vector{Float64}
